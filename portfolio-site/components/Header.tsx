  ...
  return (
    <header className="sticky top-0 z-50 glass border-b border-gray-200/50 dark:border-gray-700/50 backdrop-blur-lg">
      <nav className="container mx-auto px-4 py-5 flex items-center justify-between">
        <Link href="/" className="group text-2xl font-bold">
        ...
        <div className="flex gap-8">
          <Link 
            href="/projects" 
            className="relative font-medium text-gray-700 dark:text-gray-300 hover:text-primary transition-colors duration-300 group"
          >
            Projects
